...
class Upsampling(Module):
    ...
    def param(self):
        ...
        # TODO Quentin: this gives just the list of params of the convolution layer, since the other one is empty, check
        #  that this is what you need/want

    def update_param(self, updated_params):  # TODO Quentin: here I suppose that you directly pass the updated args for the conv
